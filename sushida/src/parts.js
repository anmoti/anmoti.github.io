function header_f() {
	var d0 = new Date(), d1 = new Date(2021, 2-1, 30);
	var n=' <span style="font-size:11px;color: #333333">2/17</span> ';
	if(d1.getTime()-d0.getTime()>0){ n+='<img src="https://neutralx0.net/img/new_w.gif" width="28" height="9" alt=""/>'; }
    var html = "";
	html += '<div id="logo"><a href="https://neutralx0.net/"><img src="https://neutralx0.net/img/logo.gif" width="120" height="40" alt=""/></a></div>';
	...
	html += '<li><p><a href="https://neutralx0.com/" target="_blank" class="topmenu">実験室+メモ</a></p></li>';
	html += '<li><p><a href="http://info.neutralx0.com/" target="_blank" class="topmenu">ヘルプ</a></p></li>';
	html += '<li><p><a href="https://twitter.com/neutral_info" target="_blank" style="color:#333">更新情報'+n+'</a></p></li>';
	html += '</ul></div>';
...
function footer_f(){
	...
	html += '<p>&copy; 2005-2021 Neutral.</p>';
	html += '</div>';
...
function sns_f(){
	...
	html +='<li><iframe src="https://www.facebook.com/plugins/like.php?href='+url+'&width=140&layout=button&action=like&size=small&share=true&height=65&appId" width="140" height="65" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe></li>';
    //hatena
